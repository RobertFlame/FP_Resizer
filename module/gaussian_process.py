...
class gp:
    ...
    def train(self, num_ite=settings.num_ite, data_ratio=settings.data_ratio):
        """
        ...
        # get size
        self.gN = min(max(int(data_ratio * total_n), 1), total_n)
        ...
        for ite in range(num_ite):
            ...
            for i in range(total_n):
                ...
                t_rssi = self.rssi[i]
                esti_rssi, _ = self.estimate_gp(t_x,t_y,sd_mode=False)
